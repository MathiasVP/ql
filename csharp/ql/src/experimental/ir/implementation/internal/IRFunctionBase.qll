...
private newtype TIRFunction =
  ...
  TVarInitIRFunction(Language::Variable var) {
    (
      var instanceof Language::GlobalVariable or
      var instanceof Language::StaticVariable
    ) and
    IRConstruction::Raw::varHasIRFunc(var)
  }
