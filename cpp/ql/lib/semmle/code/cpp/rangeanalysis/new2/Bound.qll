...
private import internal.BoundSpecific

private newtype TBound =
  TBoundZero() or
  TBoundSsa(SsaVariable v) {
    v.getSourceVariable().getType() instanceof IntegralType or
    v.getSourceVariable().getType() instanceof AddressType
  } or
  TBoundExpr(Expr e) {
    interestingExprBound(e) and
    not exists(SsaVariable v | e = v.getAUse().getDef())
  }
