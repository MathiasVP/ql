...
class Instruction extends Construction::TStageInstruction {
  ...
  final string toString() {
    exists(IRConstruction::Node n |
      this = TRawInstruction(n) and
      result = this.getResultString() + " [" + n.getSplits().toString() + "]"
    )
  }

  IRConstruction::Splits getSplit() {
    exists(IRConstruction::Node n |
      this = TRawInstruction(n) and
      result = n.(IRConstruction::InstructionNode).getSplits()
    )
  }
